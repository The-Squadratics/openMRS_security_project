...
[Hapi.js](https://github.com/hapijs/hapi) which is a javascript framework for building webapplication and other services and [Syslog-ng](https://github.com/balabit/syslog-ng) which is a open source log management project built around a system deamon etc.
